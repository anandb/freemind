...
${freedir}/plugins/svg/batik-anim.jar:\
${freedir}/plugins/svg/batik-awt-util.jar:\
${freedir}/plugins/svg/batik-bridge.jar:\
${freedir}/plugins/svg/batik-css.jar:\
${freedir}/plugins/svg/batik-codec.jar:\
${freedir}/plugins/svg/batik-dom.jar:\
${freedir}/plugins/svg/batik-extension.jar:\
${freedir}/plugins/svg/batik-ext.jar:\
${freedir}/plugins/svg/batik-gvt.jar:\
${freedir}/plugins/svg/batik-parser.jar:\
${freedir}/plugins/svg/batik-script.jar:\
${freedir}/plugins/svg/batik-svg-dom.jar:\
${freedir}/plugins/svg/batik-svggen.jar:\
${freedir}/plugins/svg/batik-transcoder.jar:\
${freedir}/plugins/svg/batik-util.jar:\
${freedir}/plugins/svg/batik-xml.jar:\
${freedir}/plugins/svg/xml-apis-ext.jar:\
${freedir}"
}
