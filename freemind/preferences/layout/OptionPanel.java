...
public class OptionPanel implements TextTranslator {
	...
	private Vector<PropertyControl> getControls() {
		...
		controls.add(new ComboProperty("icon_bar_position.tooltip", FreeMind.ICON_BAR_POSITION, new String[] { "left", "top" }, this));
		controls.add(new NumberProperty("icon_bar_row_amount.tooltip", FreeMind.ICON_BAR_ROW_AMOUNT, 1, 10, 1));
		controls.add(new NumberProperty("toolbar_icon_size.tooltip", FreeMind.RESOURCES_TOOLBAR_ICON_SIZE, 8, 128, 1));
		/***********************************************************************
		 * Keystrokes
		 * ****************************************************************
		 */
