...
import freemind.view.mindmapview.SwingHtmlEditorPanel;
...
public class EditNodeWYSIWYG extends EditNodeBase {
	...
	private static class HTMLDialog extends EditDialog {
		...
		private SwingHtmlEditorPanel htmlEditorPanel;
		...
		private SwingHtmlEditorPanel createEditorPanel() throws Exception {
			if (htmlEditorPanel == null) {
				htmlEditorPanel = new SwingHtmlEditorPanel();
			}
		 ...
		 */
		public SwingHtmlEditorPanel getHtmlEditorPanel() {
			return htmlEditorPanel;
		}
	...
	public void show() {
		...
		try {
			...
			final SwingHtmlEditorPanel htmlEditorPanel = ((HTMLDialog) htmlEditorWindow)
					.getHtmlEditorPanel();
			String rule = "BODY {";
